...
fn x64_movaps_xmm0_xmm1() {
    ...
    assert_ast_eq(
        ...
        &ast,
        r#"v0:16 = XMM1;
            range(XMM0, 0, 32) = range(v0, 0, 32);
            range(XMM0, 32, 32) = range(v0, 32, 32);
            range(XMM0, 64, 32) = range(v0, 64, 32);
            range(XMM0, 96, 32) = range(v0, 96, 32);"#,
    );
}
...
fn x64_addss_xmm3_xmm4() {
    ...
    assert_ast_eq(
        spec,
        &ast,
        r#"v3:4 = range(XMM3, 0, 32);
            v4:4 = range(XMM4, 0, 32);
            v5:1 = 0;
            v13:1 = ((range(v3, 23, 8) == 0) && (range(v3, 0, 23) != 0));
            v14:1 = (((MXCSR >> 6) & 1) != 0);
            v15:1 = (v13 && v14);
            v16:4 = (0 - zext(!v15));
            v3 = ((v3 & v16) | ((v3 & 2147483648) & ~v16));
            v5 = (v13 && !v14);
            v6:1 = 0;
            v19:1 = ((range(v4, 23, 8) == 0) && (range(v4, 0, 23) != 0));
            v20:1 = (((MXCSR >> 6) & 1) != 0);
            v21:1 = (v19 && v20);
            v22:4 = (0 - zext(!v21));
            v4 = ((v4 & v22) | ((v4 & 2147483648) & ~v22));
            v6 = (v19 && !v20);
            v7:1 = 0;
            v24:4 = ((MXCSR >> 13) & 3);
            v7 = subpiece_lsb(v24, 1);
            v8:4 = float_add(v3, v4, v7);
            v9:1 = float_add_flags(v3, v4, v7);
            v29:1 = ((range(v3, 23, 8) == 255) && (range(v3, 0, 23) != 0));
            v30:1 = ((range(v4, 23, 8) == 255) && (range(v4, 0, 23) != 0));
            v31:4 = (0 - zext(v29));
            v32:4 = (((v3 | 4194304) & v31) | ((v4 | 4194304) & ~v31));
            v33:1 = (v29 || v30);
            v34:4 = (0 - zext(v33));
            v35:4 = (0 - zext((((v9 & 1) != 0) && !v33)));
            v36:4 = (v34 | v35);
            v8 = (((v32 & v34) | (4290772992 & v35)) | (v8 & ~v36));
            v39:1 = (((MXCSR >> 15) & 1) != 0);
            v40:1 = (((MXCSR >> 11) & 1) != 0);
            v41:1 = ((range(v8, 23, 8) == 0) && (range(v8, 0, 23) != 0));
            v42:1 = ((v39 && v40) && v41);
            v43:4 = (0 - zext(!v42));
            v8 = ((v8 & v43) | ((v8 & 2147483648) & ~v43));
            v9 = (v9 | (v42 * 48));
            v10:1 = (((range(v3, 23, 8) == 255) && (range(v3, 0, 23) != 0)) || ((range(v4, 23, 8) == 255) && (range(v4, 0, 23) != 0)));
            v46:1 = ((v9 & 5) != 0);
            MXCSR = ((MXCSR | (zext(v9) & 61)) | (zext((((v5 || v6) && !v10) && !v46)) * 2));
            range(XMM3, 0, 32) = v8;"#,
    );
}
...
fn x64_movupd_xmm0_xmm1() {
    ...
    assert_ast_eq(
        ...
        &ast,
        r#"v0:16 = XMM1;
            range(XMM0, 0, 64) = range(v0, 0, 64);
            range(XMM0, 64, 64) = range(v0, 64, 64);"#,
    );
}
...
fn x64_addsd_xmm1_xmm2() {
    ...
    assert_ast_eq(
        spec,
        &ast,
        r#"v3:8 = range(XMM1, 0, 64);
            v4:8 = range(XMM2, 0, 64);
            v5:1 = 0;
            v13:1 = ((range(v3, 52, 11) == 0) && (range(v3, 0, 52) != 0));
            v14:1 = (((MXCSR >> 6) & 1) != 0);
            v15:1 = (v13 && v14);
            v16:8 = (0 - zext(!v15));
            v3 = ((v3 & v16) | ((v3 & 9223372036854775808) & ~v16));
            v5 = (v13 && !v14);
            v6:1 = 0;
            v19:1 = ((range(v4, 52, 11) == 0) && (range(v4, 0, 52) != 0));
            v20:1 = (((MXCSR >> 6) & 1) != 0);
            v21:1 = (v19 && v20);
            v22:8 = (0 - zext(!v21));
            v4 = ((v4 & v22) | ((v4 & 9223372036854775808) & ~v22));
            v6 = (v19 && !v20);
            v7:1 = 0;
            v24:4 = ((MXCSR >> 13) & 3);
            v7 = subpiece_lsb(v24, 1);
            v8:8 = float_add(v3, v4, v7);
            v9:1 = float_add_flags(v3, v4, v7);
            v29:1 = ((range(v3, 52, 11) == 2047) && (range(v3, 0, 52) != 0));
            v30:1 = ((range(v4, 52, 11) == 2047) && (range(v4, 0, 52) != 0));
            v31:8 = (0 - zext(v29));
            v32:8 = (((v3 | 2251799813685248) & v31) | ((v4 | 2251799813685248) & ~v31));
            v33:1 = (v29 || v30);
            v34:8 = (0 - zext(v33));
            v35:8 = (0 - zext((((v9 & 1) != 0) && !v33)));
            v36:8 = (v34 | v35);
            v8 = (((v32 & v34) | (18444492273895866368 & v35)) | (v8 & ~v36));
            v39:1 = (((MXCSR >> 15) & 1) != 0);
            v40:1 = (((MXCSR >> 11) & 1) != 0);
            v41:1 = ((range(v8, 52, 11) == 0) && (range(v8, 0, 52) != 0));
            v42:1 = ((v39 && v40) && v41);
            v43:8 = (0 - zext(!v42));
            v8 = ((v8 & v43) | ((v8 & 9223372036854775808) & ~v43));
            v9 = (v9 | (v42 * 48));
            v10:1 = (((range(v3, 52, 11) == 2047) && (range(v3, 0, 52) != 0)) || ((range(v4, 52, 11) == 2047) && (range(v4, 0, 52) != 0)));
            v46:1 = ((v9 & 5) != 0);
            MXCSR = ((MXCSR | (zext(v9) & 61)) | (zext((((v5 || v6) && !v10) && !v46)) * 2));
            range(XMM1, 0, 64) = v8;"#,
    );
...
fn x64_addpd_xmm6_xmm7() {
    ...
    assert_ast_eq(
        spec,
        &ast,
        r#"v3:8 = range(XMM6, 0, 64);
            v4:8 = range(XMM7, 0, 64);
            v5:1 = 0;
            v13:1 = ((range(v3, 52, 11) == 0) && (range(v3, 0, 52) != 0));
            v14:1 = (((MXCSR >> 6) & 1) != 0);
            v15:1 = (v13 && v14);
            ...
            MXCSR = ((MXCSR | (zext(v9) & 61)) | (zext((((v5 || v6) && !v10) && !v46)) * 2));
            range(XMM6, 0, 64) = v8;
            v50:8 = range(XMM6, 64, 64);
            v51:8 = range(XMM7, 64, 64);
            v52:1 = 0;
            v60:1 = ((range(v50, 52, 11) == 0) && (range(v50, 0, 52) != 0));
            v61:1 = (((MXCSR >> 6) & 1) != 0);
            v62:1 = (v60 && v61);
            v63:8 = (0 - zext(!v62));
            v50 = ((v50 & v63) | ((v50 & 9223372036854775808) & ~v63));
            v52 = (v60 && !v61);
            v53:1 = 0;
            v66:1 = ((range(v51, 52, 11) == 0) && (range(v51, 0, 52) != 0));
            v67:1 = (((MXCSR >> 6) & 1) != 0);
            v68:1 = (v66 && v67);
            v69:8 = (0 - zext(!v68));
            v51 = ((v51 & v69) | ((v51 & 9223372036854775808) & ~v69));
            v53 = (v66 && !v67);
            v54:1 = 0;
            v71:4 = ((MXCSR >> 13) & 3);
            v54 = subpiece_lsb(v71, 1);
            v55:8 = float_add(v50, v51, v54);
            v56:1 = float_add_flags(v50, v51, v54);
            v76:1 = ((range(v50, 52, 11) == 2047) && (range(v50, 0, 52) != 0));
            v77:1 = ((range(v51, 52, 11) == 2047) && (range(v51, 0, 52) != 0));
            v78:8 = (0 - zext(v76));
            v79:8 = (((v50 | 2251799813685248) & v78) | ((v51 | 2251799813685248) & ~v78));
            v80:1 = (v76 || v77);
            v81:8 = (0 - zext(v80));
            v82:8 = (0 - zext((((v56 & 1) != 0) && !v80)));
            v83:8 = (v81 | v82);
            v55 = (((v79 & v81) | (18444492273895866368 & v82)) | (v55 & ~v83));
            v86:1 = (((MXCSR >> 15) & 1) != 0);
            v87:1 = (((MXCSR >> 11) & 1) != 0);
            v88:1 = ((range(v55, 52, 11) == 0) && (range(v55, 0, 52) != 0));
            v89:1 = ((v86 && v87) && v88);
            v90:8 = (0 - zext(!v89));
            v55 = ((v55 & v90) | ((v55 & 9223372036854775808) & ~v90));
            v56 = (v56 | (v89 * 48));
            v57:1 = (((range(v50, 52, 11) == 2047) && (range(v50, 0, 52) != 0)) || ((range(v51, 52, 11) == 2047) && (range(v51, 0, 52) != 0)));
            v93:1 = ((v56 & 5) != 0);
            MXCSR = ((MXCSR | (zext(v56) & 61)) | (zext((((v52 || v53) && !v57) && !v93)) * 2));
            range(XMM6, 64, 64) = v55;"#,
    );
}
